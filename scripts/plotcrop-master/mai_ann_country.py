...
def annualyield(year,couna,counb):
    ...
    return "Maize ","iizumi harvested area",harea, "ha","iizumi yield",yieldagf,"t/ha","production",yieldg,"tonnes","ISAM-CRU yield",yieldagfi,"t/ha","production",yieldgi,"tonnes","CLM yield",yieldagfc,"t/ha","production",yieldgc,"tonnes","ISAM-CESM yield",yieldagfi1,"t/ha","production",yieldgi1,"tonnes"
    #return harea
def runmean(x,input):
        import pandas as pd
...
#leg = plt.legend(loc=2,fancybox=True, fontsize=14)
	...
	plt.savefig('maize_ag_{0}.png'.format(name1),dpi=300,bbox_inches='tight')
#plt.show()
