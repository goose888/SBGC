...
#means_fao=(95277*0.0001,62844*0.0001,27471*0.0001,41790*0.0001,16061*0.0001,17970*0.0001,36715*0.0001,94120*0.0001,92157*0.0001,13001*0.0001,92119*0.0001)
means_m3 = m3y
means_cesm=isamy1
...
#pro_fao=(10137500,6953700,2005900,4984332,4897600,4511104,4472903,652019,3991752,4107000,3324018)
pro_m3 = m3p
pro_cesm=isamp1
...
#plt.xticks(index + bar_width+0.2, ("Italy","Canada","Vietnam","Hungary","Romania","Philippines","Thailand","Chile","Spain","Nigeria","Germany"))
leg=plt.legend()
...
ha_ii = toarea
ha_fao = (137006957,29315744, 23056270,11614717 ,3088715 ,7131180,6611300,1278800,3500000,1764767,4012000)
#ha_fao=(1064000,1106500,730200,1192702,3049400,2510342,1218287,69275,433146,3159000,360841)
ha_m3 = m3area
...
plt.title('2000',fontsize=18)
plt.xticks(index + bar_width+0.1, ('Global','USA', 'China', 'Brazil', 'Argentina','Mexico','India','Ukraine','Indonesia','France','South Africa'))
#plt.xticks(index + bar_width+0.1, ("Italy","Canada","Vietnam","Hungary","Romania","Philippines","Thailand","Chile","Spain","Nigeria","Germany"))
leg=plt.legend(fontsize=18)
leg.get_frame().set_alpha(0.5)
plt.tick_params(axis='both',labelsize=15)

plt.tight_layout()
plt.savefig('maize2000_area.png')
#plt.show()
