...
for i, year in enumerate(years):
    ...
    yield1 = base.variables["fhsa"][0,:,:]
    yieldf[i, :, :] = yield1
    yield1a = basea.variables["fhsa"][0,:,:]
    yieldfa[i, :, :] = yield1a
    yield1b = baseb.variables["fhsa"][0,:,:]
    yieldfb[i, :, :] = yield1b
    yield1c = basec.variables["fhsa"][0,:,:]
    yieldfc[i, :, :] = yield1c
...
for i, year1 in enumerate(years2):
    ...
    yield2 = base2.variables["fhsa"][0,:,:]
    yieldf2[i, :, :] = yield2
    yield2a = base2a.variables["fhsa"][0,:,:]
    yieldf2a[i, :, :] = yield2a
    yield2b = base2b.variables["fhsa"][0,:,:]
    yieldf2b[i, :, :] = yield2b
    yield2c = base2c.variables["fhsa"][0,:,:]
    yieldf2c[i, :, :] = yield2c
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,(yield_new2-yield_new)/yield_new*100,cmap=plt.cm.seismic,vmin=-60,vmax=60)
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,(yield_new2b-yield_newb)/yield_newb*100,cmap=plt.cm.seismic,vmin=-60,vmax=60)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,(yield_new2c-yield_newc)/yield_newc*100,cmap=plt.cm.seismic,vmin=-60,vmax=60)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,(yield_new2d-yield_newd)/yield_newd*100,cmap=plt.cm.seismic,vmin=-60,vmax=60)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')

plt.savefig('scp85maizehs.jpg',dpi=300,bbox_inches='tight')
plt.show()
