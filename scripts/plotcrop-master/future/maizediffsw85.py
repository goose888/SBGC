...
for i, year in enumerate(years):
    ...
    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85a/output/rcp85a.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    basea = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85b/output/rcp85b.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    baseb = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85c/output/rcp85c.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    basec = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85d/output/rcp85d.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    ...
    yieldfa[i, :, :] = yield1a
    yield1b = baseb.variables["g_rootwater"][7,0,:,:]
    yieldfb[i, :, :] = yield1b
    yield1c = basec.variables["g_rootwater"][7,0,:,:]
    yieldfc[i, :, :] = yield1c

    
for i, year1 in enumerate(years2):
    base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85a/output/rcp85a.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2a = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85b/output/rcp85b.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2b = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85c/output/rcp85c.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2c = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85d/output/rcp85d.bgp-yearly_crop_{0}.nc".format(year1), mode='r')    
    yield2 = base2.variables["g_rootwater"][7,0,:,:]
    yieldf2[i, :, :] = yield2
    yield2a = base2a.variables["g_rootwater"][7,0,:,:]
    yieldf2a[i, :, :] = yield2a
    yield2b = base2b.variables["g_rootwater"][7,0,:,:]
    yieldf2b[i, :, :] = yield2b
    yield2c = base2c.variables["g_rootwater"][7,0,:,:]
    yieldf2c[i, :, :] = yield2c
...
ax1.set_title("CO2 (mm)",fontsize=18)
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2-yield_new,cmap=plt.cm.seismic,vmin=-60,vmax=60)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12) 
plt.axis('off')

ax2 = fig.add_subplot(222)
ax2.set_title("CO2+CLIMATE (mm)",fontsize=18)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2b-yield_newb,cmap=plt.cm.seismic,vmin=-60,vmax=60)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')

ax5 = fig.add_subplot(223)
ax5.set_title("CO2+CLIMATE+N (mm)",fontsize=18)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2c-yield_newc,cmap=plt.cm.seismic,vmin=-60,vmax=60)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
ax5.set_title("CO2+CLIMATE+N+I (mm)",fontsize=18)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2d-yield_newd,cmap=plt.cm.seismic,vmin=-60,vmax=60)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')

plt.savefig('scp85maizewater.jpg',dpi=300,bbox_inches='tight')
plt.show()
