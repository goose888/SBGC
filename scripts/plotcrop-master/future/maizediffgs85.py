...
for i, year in enumerate(years):
    ...
    basea = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85bm/output/rcp85bm.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    baseb = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85cm/output/rcp85cm.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    basec = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85dm/output/rcp85dm.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    lona1 = base.variables["lon"][:]
    lata1 = base.variables["lat"][:]
   
    yield1 = base.variables["growseason"][0,:,:]
    yieldf[i, :, :] = yield1
    yield1a = basea.variables["growseason"][0,:,:]
    yieldfa[i, :, :] = yield1a
    yield1b = baseb.variables["growseason"][0,:,:]
    yieldfb[i, :, :] = yield1b
    yield1c = basec.variables["growseason"][0,:,:]
    yieldfc[i, :, :] = yield1c

    
for i, year1 in enumerate(years2):
    base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85am/output/rcp85am.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2a = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85bm/output/rcp85bm.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2b = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85cm/output/rcp85cm.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2c = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85dm/output/rcp85dm.bgp-yearly_crop_{0}.nc".format(year1), mode='r')    
    yield2 = base2.variables["growseason"][0,:,:]
    yieldf2[i, :, :] = yield2
    yield2a = base2a.variables["growseason"][0,:,:]
    yieldf2a[i, :, :] = yield2a
    yield2b = base2b.variables["growseason"][0,:,:]
    yieldf2b[i, :, :] = yield2b
    yield2c = base2c.variables["growseason"][0,:,:]
    yieldf2c[i, :, :] = yield2c
...
plt.savefig('scp85maizegs.jpg',dpi=300,bbox_inches='tight')
plt.show()
