...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2-yield_new,cmap=plt.cm.RdYlGn,vmin=-150,vmax=150)
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2b-yield_newb,cmap=plt.cm.RdYlGn,vmin=-150,vmax=150)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2c-yield_newc,cmap=plt.cm.RdYlGn,vmin=-150,vmax=150)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2d-yield_newd,cmap=plt.cm.RdYlGn,vmin=-150,vmax=150)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')

plt.savefig('scp45maizerain.jpg',dpi=300,bbox_inches='tight')
plt.show()
