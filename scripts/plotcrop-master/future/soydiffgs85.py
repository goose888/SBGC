...
for i, year in enumerate(years):
    ...
    baseb = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85cs/output/rcp85cs.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    basec = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85ds/output/rcp85ds.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    lona1 = base.variables["lon"][:]
    lata1 = base.variables["lat"][:]
   
    yield1 = base.variables["growseason"][1,:,:]
    yieldf[i, :, :] = yield1
    yield1a = basea.variables["growseason"][1,:,:]
    yieldfa[i, :, :] = yield1a
    yield1b = baseb.variables["growseason"][1,:,:]
    yieldfb[i, :, :] = yield1b
    yield1c = basec.variables["growseason"][1,:,:]
    yieldfc[i, :, :] = yield1c
...
for i, year1 in enumerate(years2):
    ...
    base2b = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85cs/output/rcp85cs.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    base2c = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85ds/output/rcp85ds.bgp-yearly_crop_{0}.nc".format(year1), mode='r')    
    yield2 = base2.variables["growseason"][1,:,:]
    yieldf2[i, :, :] = yield2
    yield2a = base2a.variables["growseason"][1,:,:]
    yieldf2a[i, :, :] = yield2a
    yield2b = base2b.variables["growseason"][1,:,:]
    yieldf2b[i, :, :] = yield2b
    yield2c = base2c.variables["growseason"][1,:,:]
    yieldf2c[i, :, :] = yield2c
...
ax1.set_title("CO2 (days)",fontsize=18)
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2-yield_new,cmap=plt.cm.seismic,vmin=-40,vmax=40)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12) 
plt.axis('off')

ax2 = fig.add_subplot(222)
ax2.set_title("CO2+CLIMATE (days)",fontsize=18)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2b-yield_newb,cmap=plt.cm.seismic,vmin=-40,vmax=40)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')

ax5 = fig.add_subplot(223)
ax5.set_title("CO2+CLIMATE+N (days)",fontsize=18)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2c-yield_newc,cmap=plt.cm.seismic,vmin=-40,vmax=40)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
ax5.set_title("CO2+CLIMATE+N+I (days)",fontsize=18)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2d-yield_newd,cmap=plt.cm.seismic,vmin=-40,vmax=40)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')

plt.savefig('scp85soygs.jpg',dpi=300,bbox_inches='tight')
plt.show()
