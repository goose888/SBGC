...
#    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85ds/output/rcp85ds.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    ...
    yield1 = base.variables["g_rootwater"][7,1,:,:]
    yieldf[i, :, :] = yield1
    yield11 = basea.variables["g_rootwater"][7,1,:,:]
    yieldf1[i, :, :] = yield11
...
#    base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85ds/output/rcp85ds.bgp-yearly_crop_{0}.nc".format(year1), mode='r')    
    yield2 = base2.variables["g_rootwater"][7,1,:,:]
    yieldf2[i, :, :] = yield2

    yield21 = base2a.variables["g_rootwater"][7,1,:,:]
    yieldf21[i, :, :] = yield21
...
plt.savefig('scp85soyrwbdiff1.jpg',dpi=300,bbox_inches='tight')
plt.show()
