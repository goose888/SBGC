...
clma=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45rcp85/maizetrop_rcp85_co2_rf_nofert_0.5x0.5.nc','r')
...
clm1a=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45rcp85/maizetemp_rcp85_co2_rf_nofert_0.5x0.5.nc','r')
...
#    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85cm/output/rcp85cm.bgp-yearly_crop_{0}.nc".format(year), mode='r')
#    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85dm/output/rcp85dm.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    lona1 = base.variables["lon"][:]
    lata1 = base.variables["lat"][:]
   
    yield1 = base.variables["yield"][0,:,:]
    yieldf[i, :, :] = yield1
    yield11 = basea.variables["yield"][0,:,:]
    yieldf1[i, :, :] = yield11
...
#    base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85cm/output/rcp85cm.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
#    base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85dm/output/rcp85dm.bgp-yearly_crop_{0}.nc".format(year1), mode='r')    
    yield2 = base2.variables["yield"][0,:,:]
    yieldf2[i, :, :] = yield2

    yield21 = base2a.variables["yield"][0,:,:]
    yieldf21[i, :, :] = yield21
...
plt.savefig('scp85maizeybdiff.jpg',dpi=300,bbox_inches='tight')
plt.show()
