...
for i, year in enumerate(years):
    ...
    yield1 = base.variables["g_WS_type"][7,0,:,:]
    yieldf[i, :, :] = yield1
    yield1a = basea.variables["g_WS_type"][7,0,:,:]
    yieldfa[i, :, :] = yield1a
    yield1b = baseb.variables["g_WS_type"][7,0,:,:]
    yieldfb[i, :, :] = yield1b
    yield1c = basec.variables["g_WS_type"][7,0,:,:]
    yieldfc[i, :, :] = yield1c
...
for i, year1 in enumerate(years2):
    ...
    yield2 = base2.variables["g_WS_type"][7,0,:,:]
    yieldf2[i, :, :] = yield2
    yield2a = base2a.variables["g_WS_type"][7,0,:,:]
    yieldf2a[i, :, :] = yield2a
    yield2b = base2b.variables["g_WS_type"][7,0,:,:]
    yieldf2b[i, :, :] = yield2b
    yield2c = base2c.variables["g_WS_type"][7,0,:,:]
    yieldf2c[i, :, :] = yield2c
...
plt.savefig('scp45maizews.jpg',dpi=300,bbox_inches='tight')
plt.show()
