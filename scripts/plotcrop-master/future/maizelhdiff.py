...
clma=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45rcp45/maizetrop_rcp45_co2_irrig_fert_0.5x0.5.nc','r')
...
clm1a=NetCDFFile('/scratch2/scratchdirs/tslin2/plot/globalcrop/data/clm/clm45rcp45/maizetemp_rcp45_co2_irrig_fert_0.5x0.5.nc','r')
...
#    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp45bm/output/rcp45bm.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    ...
    basea = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp45dm/output/rcp45dm.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    lona1 = base.variables["lon"][:]
    lata1 = base.variables["lat"][:]
   
    yield1 = base.variables["g_ET"][0,:,:]
    yieldf[i, :, :] = yield1
    yield11 = basea.variables["g_ET"][0,:,:]
    yieldf1[i, :, :] = yield11
...
#    base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp45bm/output/rcp45bm.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
    ...
    yield2 = base2.variables["g_ET"][0,:,:]
    yieldf2[i, :, :] = yield2

    yield21 = base2a.variables["g_ET"][0,:,:]
    yieldf21[i, :, :] = yield21
...
plt.savefig('scp45maizeetddiff1.jpg',dpi=300,bbox_inches='tight')
plt.show()
