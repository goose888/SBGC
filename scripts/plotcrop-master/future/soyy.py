...
#    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp45bs/output/rcp45bs.bgp-yearly_crop_{0}.nc".format(year), mode='r')
...
#    base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp45bs/output/rcp45bs.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
...
plt.savefig('scp45soyya1.jpg',dpi=300,bbox_inches='tight')
plt.show()
