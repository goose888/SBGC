...
yield_new= ma.masked_where( clmhis1[:,:]<=0,yield_new)
yield_new2=ma.masked_where( clmfuture1[:,:]<=0,yield_new2)
...
ax1.set_title("ISAM CO2 water stress 2010s ",fontsize=18)
...
cs = map.pcolormesh(x,y,1-yield_new,cmap=plt.cm.jet,vmin=0,vmax=1)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12) 
plt.axis('off')

ax2 = fig.add_subplot(222)
ax2.set_title("ISAM CO2+CLIMATE water stress 2010s",fontsize=18)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
...
cs = map.pcolormesh(x,y,1-yield_new1,cmap=plt.cm.jet,vmin=0,vmax=1)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')

ax5 = fig.add_subplot(223)
ax5.set_title("ISAM CO2 water stress 2050s",fontsize=18)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
...
cs = map.pcolormesh(x,y,1-yield_new2,cmap=plt.cm.jet,vmin=0,vmax=1)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
ax5.set_title("ISAM CO2+CLIMATE water stress 2050s",fontsize=18)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
...
cas= ma.masked_where(cas==0.,cas)
cs = map.pcolormesh(x,y,1-yield_new21,cmap=plt.cm.jet,vmin=0,vmax=1)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')

plt.savefig('scp85soywsb1.jpg',dpi=300,bbox_inches='tight')
plt.show()
