...
#    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85ds/output/rcp85ds.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    ...
    yield1 = base.variables["g_LH"][1,:,:]
    yieldf[i, :, :] = yield1
    yield11 = basea.variables["g_LH"][1,:,:]
    yieldf1[i, :, :] = yield11
...
#    base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85ds/output/rcp85ds.bgp-yearly_crop_{0}.nc".format(year1), mode='r')    
    yield2 = base2.variables["g_LH"][1,:,:]
    yieldf2[i, :, :] = yield2

    yield21 = base2a.variables["g_LH"][1,:,:]
    yieldf21[i, :, :] = yield21
...
cs = map.pcolormesh(x,y,cisa/yield_new*100,cmap=plt.cm.bwr,vmin=-5,vmax=5)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
cas= ma.masked_where(cas==0.,cas)
cs = map.pcolormesh(x,y,cas/yield_new2*100,cmap=plt.cm.bwr,vmin=-5,vmax=5)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')

plt.savefig('scp85soyetbdiff1.jpg',dpi=300,bbox_inches='tight')
plt.show()
