...
for i, year in enumerate(years):
    ...
    yieldfa[i, :, :] = yield1a
    yield1b = baseb.variables["g_Precip"][7,0,:,:]
    yieldfb[i, :, :] = yield1b
    yield1c = basec.variables["g_Precip"][7,0,:,:]
    yieldfc[i, :, :] = yield1c
...
for i, year1 in enumerate(years2):
    ...
    yieldf2a[i, :, :] = yield2a
    yield2b = base2b.variables["g_Precip"][7,0,:,:]
    yieldf2b[i, :, :] = yield2b
    yield2c = base2c.variables["g_Precip"][7,0,:,:]
    yieldf2c[i, :, :] = yield2c
...
ax1.set_title("CO2 (mm/yr)",fontsize=18)
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2-yield_new,cmap=plt.cm.RdYlGn,vmin=-60,vmax=60)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12) 
plt.axis('off')

ax2 = fig.add_subplot(222)
ax2.set_title("CO2+CLIMATE (mm/yr)",fontsize=18)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2b-yield_newb,cmap=plt.cm.RdYlGn,vmin=-60,vmax=60)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')

ax5 = fig.add_subplot(223)
ax5.set_title("CO2+CLIMATE+N (mm/yr)",fontsize=18)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2c-yield_newc,cmap=plt.cm.RdYlGn,vmin=-60,vmax=60)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
ax5.set_title("CO2+CLIMATE+N+I (mm/yr)",fontsize=18)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yield_new2d-yield_newd,cmap=plt.cm.RdYlGn,vmin=-60,vmax=60)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')

plt.savefig('scp85maizerain.jpg',dpi=300,bbox_inches='tight')
plt.show()
