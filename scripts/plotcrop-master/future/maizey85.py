...
#    base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85bm/output/rcp85bm.bgp-yearly_crop_{0}.nc".format(year), mode='r')
...
#    base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp85bm/output/rcp85bm.bgp-yearly_crop_{0}.nc".format(year1), mode='r')
...
cs = map.pcolormesh(x,y,yield_new,cmap=plt.cm.jet,vmin=0,vmax=15)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
plt.savefig('scp85maizeya1.jpg',dpi=300,bbox_inches='tight')
plt.show()
