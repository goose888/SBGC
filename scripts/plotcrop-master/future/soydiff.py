...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yieldclm,cmap=plt.cm.RdYlGn,vmin=-1.5,vmax=1.5)
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,yieldisam,cmap=plt.cm.RdYlGn,vmin=-1.5,vmax=1.5)
cbar = map.colorbar(cs,location='bottom',size="4%",pad="2%")
cbar.ax.tick_params(labelsize=12)
plt.axis('off')
...
plt.savefig('scp45soya1.jpg',dpi=300,bbox_inches='tight')
plt.show()
