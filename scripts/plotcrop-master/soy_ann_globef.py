...
def annualyield(year,couna,counb):
    ...
    for i, year in enumerate(years):
        ...
        base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp45bs/output/rcp45bs.bgp-yearly_crop_{0}.nc".format(year), mode='r')
        ...
        basei = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp45cs/output/rcp45cs.bgp-yearly_crop_{0}.nc".format(year), mode='r')
        base2i = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_future/rcp45ds/output/rcp45ds.bgp-yearly_crop_{0}.nc".format(year), mode='r')
    ...
    return "soy ","iizumi harvested area",harea, "ha","iizumi yield",yieldagf,"t/ha","production",yieldg,"tonnes","ISAM-a yield",yieldagfa,"t/ha","CLM-a yield",yieldagfa1,"t/ha","ISAM-b yield",yieldagfb,"t/ha","clm-a yield",yieldagfb1,"tonnes","ISAM-c yield",yieldagfc,"t/ha","clm-c yield",yieldagfc1,"t/ha","ISAM-d yield",yieldagfd,"clm-a yield",yieldagfd1
    #return harea
def runmean(x,input):
        import pandas as pd
...
#plt.xticks(xdates, xdates)
	...
	plt.ylabel("yield (t/ha)",fontsize=18)
	...
	plt.savefig('soy_rcp45_{0}.png'.format(name1),dpi=300,bbox_inches='tight')
plt.show()
