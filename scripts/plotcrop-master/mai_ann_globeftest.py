...
def annualyield(year,couna,counb):
    ...
    for i, year in enumerate(years):
        base = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_his/cesmhis_m/output/cesmhis_m.bgp-yearly_crop_{0}.nc".format(year), mode='r')
        base2 = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_his/cesmhis_m/output_non/cesmhis_m.bgp-yearly_crop_{0}.nc".format(year), mode='r')
        ...
        basei = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_his/cesmhis_m/output/cesmhis_m.bgp-yearly_crop_{0}.nc".format(year), mode='r')
        base2i = NetCDFFile ("/scratch2/scratchdirs/tslin2/isam/model/global/isam_his/cesmhis_m/output_non/cesmhis_m.bgp-yearly_crop_{0}.nc".format(year), mode='r')
...
#plt.xticks(xdates, xdates)
	...
	plt.savefig('maize_histest_{0}.png'.format(name1),dpi=300,bbox_inches='tight')
plt.show()
