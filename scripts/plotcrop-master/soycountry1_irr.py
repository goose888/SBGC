...
#USA 11501~11550
	...
	return "Soybean","iizumi harvested area",harea, "ha","iizumi yield",yieldagf,"t/ha","production",yieldg,"tonnes","ISAM-CRU yield",yieldagfi,"t/ha","production",yieldgi,"tonnes","CLM yield",yieldagfc,"t/ha","production",yieldgc,"tonnes","ISAM-CESM yield",yieldagfi1,"t/ha","production",yieldgi1,"tonnes","M3 harvested area","no", "ha","M3 yield",m3yieldag,"t/ha","production",m3yieldg,"tonnes"
...
means_guido = isamy
means_final = clmy
means_fao = (21689*0.0001,35761*0.0001,25875*0.0001,25613*0.0001,25483*0.0001 ,25331*0.0001,23999*0.0001,23312*0.0001,22616*0.0001,19406*0.0001,19184*0.0001,16559*0.0001,16364*0.0001,15778*0.0001,14531*0.0001,13135*0.0001,12075*0.0001,12031*0.0001,10138*0.0001,8298*0.0001,8222*0.0001,7640*0.0001)
means_m3 = m3y
means_cesm=isamy1
...
plt.ylabel('Soybean yield (t/ha)',fontsize=40)
...
plt.tight_layout()
plt.savefig('soy2000edison_irr1.png')
#plt.show()
...
plt.savefig('scatter_soy_count.png',bbox_inches='tight')
