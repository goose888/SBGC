...
def annualyield(year,couna,counb):
    ...
    maitrop = region1.variables['soy_trop'][ba,:,:]
    maitemp = region1.variables['soy_temp'][ba,:,:]
    maitropi=region1.variables['soy_trop_irrig'][ba,:,:]
    maitempi=region1.variables['soy_temp_irrig'][ba,:,:]
...
#leg = plt.legend(loc=2,fancybox=True, fontsize=14)
	...
	plt.savefig('soy_fao1s_{0}.png'.format(name1),dpi=300,bbox_inches='tight')
#plt.show()
