...
ax1.set_title("M3 Maize Yield gridecll (kg/$\mathregular{m^2}$)",fontsize=20)
...
#print maskus_new
cs = map.pcolormesh(x,y,ncvar_maizef*ncvar_maize1*1000/gridarea,cmap=plt.cm.YlGn,vmin=0.01,vmax=0.15)
...
cs1 = map.pcolormesh(x,y,yield_fine*ncvar_maize1*1000/gridarea,cmap=plt.cm.YlGn,vmin=0.01,vmax=0.15)
...
cs1 = map.pcolormesh(x,y,yield_clmtf*ncvar_maize1*1000/gridarea,cmap=plt.cm.YlGn,vmin=0.01,vmax=0.15)
...
ax2.set_title("ISAM-M3 Maize Yield gridcell (kg/$\mathregular{m^2}$)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(projection='robin',lon_0=0,resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,(yield_fine*ncvar_maize1*1000/gridarea)-(ncvar_maizef*ncvar_maize1*1000/gridarea),cmap=plt.cm.bwr,vmin=-0.1,vmax=0.1)
...
ax2.set_title("CLM-M3 Maize Yield gridcell (kg/$\mathregular{m^2}$)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(projection='robin',lon_0=0,resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,(yield_clmtf*ncvar_maize1*1000/gridarea)-(ncvar_maizef*ncvar_maize1*1000/gridarea),cmap=plt.cm.bwr,vmin=-0.1,vmax=0.1)
#cs1 = map.pcolormesh(x,y,(yield_fine)-(ncvar_maizef),cmap=plt.cm.bwr,vmin=-0.5,vmax=0.5)
...
plt.savefig('maim3_cesm.jpg',dpi=300,bbox_inches='tight')
#plt.show()
...
ax.plot([0,1.2],[0,1.2], 'k--',label='1:1')
...
plt.savefig('scatter_maim3_cesm.png',bbox_inches='tight')
#plt.show()
