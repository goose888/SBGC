...
for i, year in enumerate(years):
    ...
    yield12 = base1.variables["fhsa"][1,:,:]
    yieldfi[i, :, :] = yield12
    ...
    yield23 = basei1.variables["fhsa"][1,:,:]
    yieldf2i[i, :, :] = yield23
...
ax.set_title("ISAM CESM-NCEP heat stress (yr)",fontsize=18)
...
plt.savefig('soyizisam_hs100.jpg',dpi=300,bbox_inches='tight')
