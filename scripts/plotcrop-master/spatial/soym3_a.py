...
#print maskus_new
cs = map.pcolormesh(x,y,ncvar_maizef*ncvar_maize1*1000/gridarea*1000,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=50)
cbar = map.colorbar(cs,location='bottom',size="5%",pad="2%")
cbar.ax.tick_params(labelsize=15) 
plt.axis('off')
plt.savefig('soym3.jpg',dpi=300,bbox_inches='tight')


fig = plt.figure(figsize=(20,15))

ax2 = fig.add_subplot(321)
ax2.set_title("ISAM-CESM Soybean Yield gridcell (g/$\mathregular{m^2}$)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
cs1 = map.pcolormesh(x,y,yield_fine*ncvar_maize1*1000/gridarea*1000,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=50)
...
cs1 = map.pcolormesh(x,y,yield_clmtf*ncvar_maize1*1000/gridarea*1000,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=50)
...
ax2.set_title("ISAM-M3 Soybean Yield gridcell (g/$\mathregular{m^2}$)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(projection='robin',lon_0=0,resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,(yield_fine*ncvar_maize1*1000/gridarea*1000)-(ncvar_maizef*ncvar_maize1*1000/gridarea*1000),cmap=plt.cm.bwr,vmin=-50,vmax=50)
...
ax2.set_title("CLM-M3 Soybean Yield gridcell (g/$\mathregular{m^2}$)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(projection='robin',lon_0=0,resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,(yield_clmtf*ncvar_maize1*1000/gridarea*1000)-(ncvar_maizef*ncvar_maize1*1000/gridarea*1000),cmap=plt.cm.bwr,vmin=-50,vmax=50)
#cs1 = map.pcolormesh(x,y,(yield_fine)-(ncvar_maizef),cmap=plt.cm.bwr,vmin=-0.5,vmax=0.5)
...
ax2.set_title("ISAM-M3 Soybean Yield gridcell (%)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(projection='robin',lon_0=0,resolution='c')
map.drawcoastlines()
map.drawcountries()
...
ax2.set_title("CLM-M3 Soybean Yield gridcell (%)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(projection='robin',lon_0=0,resolution='c')
map.drawcoastlines()
map.drawcountries()
...
ax.plot([0,500],[0,500], 'k--',label='1:1')
