...
ax1.set_title("Iizumi Soybean Yield gridecll (kg/$\mathregular{m^2}$)",fontsize=20)
...
cs = map.pcolormesh(x,y,iyield*iarea/100/10,cmap=plt.cm.YlGn,vmin=0.01,vmax=0.1)
...
ax2.set_title("ISAM-NCEP Soybean Yield gridcell (kg/$\mathregular{m^2}$)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
cs1 = map.pcolormesh(x,y,yield_new*iarea/100/10,cmap=plt.cm.YlGn,vmin=0.01,vmax=0.1)
...
cs1 = map.pcolormesh(x,y,yield_clmtf*iarea/100/10,cmap=plt.cm.YlGn,vmin=0.01,vmax=0.1)
cbar = map.colorbar(cs1,location='bottom',size="5%",pad="2%")
cbar.ax.tick_params(labelsize=18) 
plt.axis('off')
#print N.max(yield_fine*ncvar_maize1*1000/gridarea)
...
ax2.set_title("ISAM-Iizumi Soybean Yield gridcell (kg/$\mathregular{m^2}$)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(projection='robin',lon_0=0,resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,(yield_new*iarea/100/10)-(iyield*iarea/100/10),cmap=plt.cm.bwr,vmin=-0.05,vmax=0.05)
...
ax2.set_title("CLM-Iizumi Soybean Yield gridcell (kg/$\mathregular{m^2}$)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(projection='robin',lon_0=0,resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,(yield_clmtf*iarea/100/10)-(iyield*iarea/100/10),cmap=plt.cm.bwr,vmin=-0.05,vmax=0.05)
...
ax.plot([0,0.25],[0,0.25], 'k--',label='1:1')
