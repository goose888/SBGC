...
cs = map.pcolormesh(x,y,iizumy,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=50)

cbar = map.colorbar(cs,location='bottom',size="5%",pad="2%")
cbar.ax.tick_params(labelsize=15)
plt.axis('off')
plt.savefig('soyiizirr.jpg',dpi=300,bbox_inches='tight')
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,isamy-iizumy,cmap=plt.cm.bwr,vmin=-50,vmax=50)
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,clmy-iizumy,cmap=plt.cm.bwr,vmin=-50,vmax=50)
...
plt.savefig('soyiizirr_ncep.jpg',dpi=300,bbox_inches='tight')
#plt.show()
...
plt.savefig('scatter_soyiizirr_ncep.png',bbox_inches='tight')
#plt.show()
