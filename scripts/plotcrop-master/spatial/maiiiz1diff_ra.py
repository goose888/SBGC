...
for i, year in enumerate(years):
    ...
    yield12 = base1.variables["g_Rn"][0,:,:]
    yieldfi[i, :, :] = yield12
    ...
    yield23 = basei1.variables["g_Rn"][0,:,:]
    yieldf2i[i, :, :] = yield23
...
ax.set_title("ISAM CESM-NCEP Maize net absorbed radiation (W/m2/yr)",fontsize=18)
...
plt.savefig('maiiizisam_ra100.jpg',dpi=300,bbox_inches='tight')
