...
for i, year in enumerate(years):
    ...
    yield1 = base.variables["begingrowdate"][1,:,:]
    yieldf[i, :, :] = yield1
    ...
    yield2 = basei.variables["begingrowdate"][1,:,:]
    yieldf2[i, :, :] = yield2
    ...
    yield12 = base1.variables["begingrowdate"][1,:,:]
    yieldfi[i, :, :] = yield12
    ...
    yield23 = basei1.variables["begingrowdate"][1,:,:]
    yieldf2i[i, :, :] = yield23
...
ax.set_title("ISAM CESM-NCEP planting date (d/yr)",fontsize=18)
...
plt.savefig('soyiizisam_plant100.jpg',dpi=300,bbox_inches='tight')
