...
for i, year in enumerate(years):
    ...
    yield2 = basei.variables["growseason"][0,:,:]
    yieldf2[i, :, :] = yield2
    ...
    yield12 = base1.variables["growseason"][0,:,:]
    yieldfi[i, :, :] = yield12
    ...
    yield23 = basei1.variables["growseason"][0,:,:]
    yieldf2i[i, :, :] = yield23
...
ax.set_title("ISAM CESM-NCEP Maize growing length (d/yr)",fontsize=18)
...
plt.savefig('maiiizisam_grow100.jpg',dpi=300,bbox_inches='tight')
