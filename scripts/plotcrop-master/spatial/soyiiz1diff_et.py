...
for i, year in enumerate(years):
    ...
    yield12 = base1.variables["g_ET"][1,:,:]
    yieldfi[i, :, :] = yield12
    ...
    yield23 = basei1.variables["g_ET"][1,:,:]
    yieldf2i[i, :, :] = yield23
...
ax.set_title("ISAM CESM-NCEP ET (mm/yr)",fontsize=18)
...
plt.savefig('soyiizisam_et100.jpg',dpi=300,bbox_inches='tight')
