...
ax.set_title("M3 Soybean Yield (t/ha)",fontsize=20)
...
#print maskus_new
m3y=ncvar_maizef
cs = map.pcolormesh(x,y,m3y,cmap=plt.cm.YlGn,vmin=0,vmax=6)
cbar = map.colorbar(cs,location='bottom',size="5%",pad="2%")
cbar.ax.tick_params(labelsize=15) 
plt.axis('off')
plt.savefig('soyirrm31.jpg',dpi=300,bbox_inches='tight')
...
ax2.set_title("ISAM-M3 Soybean Yield (t/ha)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
...
ax2.set_title("CLM-M3 Soybean Yield (t/ha)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(projection='robin',lon_0=0,resolution='c')
map.drawcoastlines()
map.drawcountries()
...
ax2.set_title("ISAM-M3 Soybean Yield (%)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(projection='robin',lon_0=0,resolution='c')
map.drawcoastlines()
map.drawcountries()
...
ax2.set_title("CLM-M3 Soybean Yield (%)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(projection='robin',lon_0=0,resolution='c')
map.drawcoastlines()
map.drawcountries()
...
plt.savefig('soym3irr1_cesm.jpg',dpi=300,bbox_inches='tight')
#plt.show()
...
plt.savefig('scatter_soym3irr1_cesm.png',bbox_inches='tight')
#plt.show()
