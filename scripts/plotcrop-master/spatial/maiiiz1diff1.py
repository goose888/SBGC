...
for i, year in enumerate(years):
    ...
    yield12 = base1.variables["yield"][0,:,:]
    yieldfi[i, :, :] = yield12
    ...
    yield23 = basei1.variables["yield"][0,:,:]
    yieldf2i[i, :, :] = yield23
...
ax.set_title("ISAM CESM-NCEP Maize Yield gridecll (t/ha)",fontsize=18)
...
plt.savefig('maiiizisam100.jpg',dpi=300,bbox_inches='tight')
