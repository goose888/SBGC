...
ax.set_title("Iizumi Soybean Yield (t/ha)",fontsize=20)
...
plt.axis('off')
plt.savefig('soyiizirr1.jpg',dpi=300,bbox_inches='tight')

fig = plt.figure(figsize=(20,15))


ax2 = fig.add_subplot(321)
ax2.set_title("ISAM-CESM Soybean Yield (t/ha)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
x,y = map(lon2,lat2)
iyield = ma.masked_where(iyield<=0,iyield)
iarea = ma.masked_where(iarea<=0,iarea)
...
isamy=((yield_new*maizetor*gridarea)+(yield_new2*maizetoi*gridarea))/((gridarea*maizetor)+(gridarea*maizetoi))
cs1 = map.pcolormesh(x,y,isamy,cmap=plt.cm.YlGn,vmin=0,vmax=6)
...
ax2.set_title("CLM Soybean Yield (t/ha)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
...
clmy=((yield_clmtf*maizetor*gridarea)+(yield_clmtfi*maizetoi*gridarea))/((gridarea*maizetor)+(gridarea*maizetoi))
clmy = ma.masked_where(iizumy<=0,clmy)

cs1 = map.pcolormesh(x,y,clmy,cmap=plt.cm.YlGn,vmin=0,vmax=6)
...
ax2.set_title("ISAM-Iizumi Soybean Yield (t/ha)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(projection='robin',lon_0=0,resolution='c')
map.drawcoastlines()
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,isamy-iizumy,cmap=plt.cm.bwr,vmin=-5,vmax=5)
...
ax2.set_title("CLM-Iizumi Soybean Yield (t/ha)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(projection='robin',lon_0=0,resolution='c')
map.drawcoastlines()
map.drawcountries()
...
ax2.set_title("ISAM-Iizumi Soybean Yield (%)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(projection='robin',lon_0=0,resolution='c')
map.drawcoastlines()
map.drawcountries()
...
ax2.set_title("CLM-Iizumi Soybean Yield (%)",fontsize=20)
map = Basemap(projection ='cyl', llcrnrlat=-65, urcrnrlat=90,llcrnrlon=-180, urcrnrlon=180, resolution='c')
#map = Basemap(projection='robin',lon_0=0,resolution='c')
map.drawcoastlines()
map.drawcountries()
...
plt.savefig('soyiizirr1_cesm.jpg',dpi=300,bbox_inches='tight')
#plt.show()
...
#ax.scatter(iizumy, clmy, c=colorsr,alpha=1,label='CLM')
ax.plot([0,6],[0,6], 'k--',label='1:1')
...
plt.savefig('scatter_soyiizirr1_cesm.png',bbox_inches='tight')
#plt.show()
