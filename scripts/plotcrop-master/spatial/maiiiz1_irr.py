...
cs = map.pcolormesh(x,y,iizumy,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=100)
...
cs1 = map.pcolormesh(x,y,isamy,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=100)
...
clmy=((yield_clmtf*maizetor*gridarea)+(yield_clmtfi*maizetoi*gridarea))*100/gridarea
clmy = ma.masked_where(iizumy<=0,clmy)

cs1 = map.pcolormesh(x,y,clmy,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=100)
...
cs1 = map.pcolormesh(x,y,cd,cmap=plt.cm.bwr,vmin=-100,vmax=100)
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,clmy-iizumy,cmap=plt.cm.bwr,vmin=-100,vmax=100)
...
#plt.savefig('maiiizirr_ncep.jpg',dpi=300,bbox_inches='tight')
plt.show()
...
plt.savefig('scatter_maiiizirr_ncep.png',bbox_inches='tight')
#plt.show()
