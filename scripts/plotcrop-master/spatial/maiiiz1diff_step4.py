...
for i, year in enumerate(years):
    ...
    yield2 = basei.variables["step4"][0,:,:]
    yieldf2[i, :, :] = yield2
    ...
    yield12 = base1.variables["step4"][0,:,:]
    yieldfi[i, :, :] = yield12
    ...
    yield23 = basei1.variables["step4"][0,:,:]
    yieldf2i[i, :, :] = yield23
...
ax.set_title("ISAM CESM-NCEP Maize step4 (d/yr)",fontsize=18)
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,cc,cmap=plt.cm.bwr,vmin=-20,vmax=20)
cbar = map.colorbar(cs,location='bottom',size="5%",pad="2%")
cbar.ax.tick_params(labelsize=15)
plt.axis('off')
#plt.savefig('maiiizisam.jpg')
plt.savefig('maiiizisam_4step100.jpg',dpi=300,bbox_inches='tight')
