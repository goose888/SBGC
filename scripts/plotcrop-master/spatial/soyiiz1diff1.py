...
ax.set_title("ISAM CESM-NCEP Soybean Yield gridecll (t/ha)",fontsize=18)
...
map.drawcountries()
map.drawmapboundary()
cs = map.pcolormesh(x,y,cc,cmap=plt.cm.bwr,vmin=-2,vmax=2)
cbar = map.colorbar(cs,location='bottom',size="5%",pad="2%")
cbar.ax.tick_params(labelsize=15)
plt.axis('off')
#plt.savefig('maiiizisam.jpg')
plt.savefig('soyiizisam100.jpg',dpi=300,bbox_inches='tight')
