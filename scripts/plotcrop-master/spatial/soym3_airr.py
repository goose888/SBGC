...
cs = map.pcolormesh(x,y,m3y,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=50)
cbar = map.colorbar(cs,location='bottom',size="5%",pad="2%")
cbar.ax.tick_params(labelsize=15) 
plt.axis('off')
plt.savefig('soyirrm3.jpg',dpi=300,bbox_inches='tight')
...
isamy=((yield_fine*mask_clmra*gridarea)+(yield_fine2*mask_clmii*gridarea))*100/gridarea


cs1 = map.pcolormesh(x,y,isamy,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=50)
...
clmy=((yield_clmtf1*mask_clmra*gridarea)+(yield_clmtfi1*mask_clmii*gridarea))*100/gridarea
clmy = ma.masked_where(ncvar_maizef<=0,clmy)


cs1 = map.pcolormesh(x,y,clmy,cmap=plt.cm.YlGn,norm=colors.PowerNorm(gamma=1./2.),vmin=0,vmax=50)
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,isamy-m3y,cmap=plt.cm.bwr,vmin=-50,vmax=50)
...
map.drawcountries()
map.drawmapboundary()
cs1 = map.pcolormesh(x,y,clmy-m3y,cmap=plt.cm.bwr,vmin=-50,vmax=50)
#cs1 = map.pcolormesh(x,y,(yield_fine)-(ncvar_maizef),cmap=plt.cm.bwr,vmin=-0.5,vmax=0.5)
...
plt.savefig('soym3irr_ncep.jpg',dpi=300,bbox_inches='tight')
#plt.show()
...
plt.savefig('scatter_soym3irr_ncep.png',bbox_inches='tight')
#plt.show()
