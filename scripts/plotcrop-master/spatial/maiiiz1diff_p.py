...
for i, year in enumerate(years):
    ...
    yield2 = basei.variables["g_Precip"][7,0,:,:]
    yieldf2[i, :, :] = yield2
    ...
    yield12 = base1.variables["g_Precip"][7,0,:,:]
    yieldfi[i, :, :] = yield12
    ...
    yield23 = basei1.variables["g_Precip"][7,0,:,:]
    yieldf2i[i, :, :] = yield23
...
ax.set_title("ISAM CESM-NCEP Maize P (mm/yr)",fontsize=18)
...
plt.savefig('maiiizisam_p100.jpg',dpi=300,bbox_inches='tight')
