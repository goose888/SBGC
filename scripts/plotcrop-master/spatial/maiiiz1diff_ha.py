...
for i, year in enumerate(years):
    ...
    yield1 = base.variables["offset"][0,:,:]
    yieldf[i, :, :] = yield1
    ...
    yield2 = basei.variables["offset"][0,:,:]
    yieldf2[i, :, :] = yield2
    ...
    yield12 = base1.variables["offset"][0,:,:]
    yieldfi[i, :, :] = yield12
    ...
    yield23 = basei1.variables["offset"][0,:,:]
    yieldf2i[i, :, :] = yield23
...
ax.set_title("ISAM CESM-NCEP Maize harvest date (d/yr)",fontsize=18)
...
plt.savefig('maiiizisam_ha100.jpg',dpi=300,bbox_inches='tight')
