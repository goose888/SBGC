...
if(plot_ensemble){
   ...
   pdf(file="Beringtaiga_clean.pdf", width=17, height=10)
}
# Set margin
...
if(plot_ensemble){
   ...
   plot(c_data_1, depth_1, xlab="", ylab="", #xlab = "Cumulative root fraction", ylab = "Soil depth (cm)", 
      ylim=rev(c(0,200)), pch=17, cex= 0, xaxt='n', yaxt='n')
   lines(c_1_mean, depth, lwd = 4, xaxt='n', yaxt='n')
   lines(c_1_mean+c_1_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
   lines(c_1_mean-c_1_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
}
...
text(100, 120, "Bering Taiga", cex = 3)
dev.off()
...
#   lines(c_2_mean+c_2_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
#   lines(c_2_mean-c_2_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
#}
## Move axis to top and left
...
if(plot_ensemble){
   ...
   pdf(file="Alaskarangetransition_clean.pdf", width=17, height=10)
}
# Set margin
par(omi=c(0,0.3,0,0), mar=c(2,8,8,2)) # all plots on one page 
if(plot_ensemble){
   ...
   lines(c_3_mean+c_3_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
   lines(c_3_mean-c_3_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
}
# Move axis to top and left
axis(3,at=seq(0.0,200.0,by=20),cex.axis=3)
...
grid(NULL, NULL, col = "lightgray", lty = "dotted", lwd = 3, equilogs = TRUE)
#legend(108, 135, legend = c("   Soil Samples"), cex=3, pch = 17, bty = "n")
legend(100, 150, legend = c("Fitted profile"), cex=3, lty=1, col=c("black","gray50"), lwd=3, bty = "n")#, lty = 1:7,
     #  pch = "*", ncol = 4, cex = 0.8)
# Put Label for X and Y axis
mtext("Soil Depth (cm)", side=2, outer=TRUE, line=-2, cex=3)
mtext("Organic Carbon Density (kgC/m3)", side=3, outer=TRUE,line=-3.7,cex=3)
...
if(plot_ensemble){
   ...
   pdf(file="Coastalrainforest_clean.pdf", width=17, height=10)
}
# Set margin
par(omi=c(0,0.3,0,0), mar=c(2,8,8,2)) # all plots on one page 
if(plot_ensemble){
   ...
   lines(c_4_mean+c_4_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
   lines(c_4_mean-c_4_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
}
# Move axis to top and left
...
mtext("Soil Depth (cm)", side=2, outer=TRUE, line=-2, cex=3)
mtext("Organic Carbon Density (kgC/m3)", side=3, outer=TRUE,line=-3.7,cex=3)
text(135, 120, "Coastal Rainforest", cex = 3)
dev.off()
...
if(plot_ensemble){
   ...
   pdf(file="Arctictundra_clean.pdf", width=17, height=10)
}
# Set margin
par(omi=c(0,0.3,0,0), mar=c(2,8,8,2)) # all plots on one page 
if(plot_ensemble){
   ...
   lines(c_5_mean+c_5_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
   lines(c_5_mean-c_5_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
}
# Move axis to top and left
axis(3,at=seq(0.0,200.0,by=5),cex.axis=3)
axis(3,at=seq(0.0,200.0,by=5),labels=FALSE,tcl=-0.25)
axis(2,at=seq(200,0,by=-20),cex.axis=3, las=1)
axis(2,at=seq(200,0,by=-20),labels=FALSE,tcl=-0.25)
grid(NULL, NULL, col = "lightgray", lty = "dotted", lwd = 3, equilogs = TRUE)
#legend(108, 135, legend = c("   Soil Samples"), cex=3, pch = 17, bty = "n")
...
if(plot_ensemble){
   ...
   pdf(file="Beringtundra_clean.pdf", width=17, height=10)
}
# Set margin
par(omi=c(0,0.3,0,0), mar=c(2,8,8,2)) # all plots on one page 
if(plot_ensemble){
   ...
   plot(c_data_6, depth_6, xlab="", ylab="", #xlab = "Cumulative root fraction", ylab = "Soil depth (cm)", 
      xlim=c(0, 220), ylim=rev(c(0,200)), pch=17, cex= 0, xaxt='n', yaxt='n')
   lines(c_6_mean, depth, lwd = 4, xaxt='n', yaxt='n')
   lines(c_6_mean+c_6_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
   lines(c_6_mean-c_6_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
}
# Move axis to top and left
axis(3,at=seq(0.0,220.0,by=20),cex.axis=3)
axis(3,at=seq(0.0,220.0,by=20),labels=FALSE,tcl=-0.25)
axis(2,at=seq(200,0,by=-20),cex.axis=3, las=1)
axis(2,at=seq(200,0,by=-20),labels=FALSE,tcl=-0.25)
grid(NULL, NULL, col = "lightgray", lty = "dotted", lwd = 3, equilogs = TRUE)
#legend(108, 135, legend = c("   Soil Samples"), cex=3, pch = 17, bty = "n")
...
if(plot_ensemble){
   ...
   pdf(file="Pacificmountaintransition_clean.pdf", width=17, height=10)
}
# Set margin
par(omi=c(0,0.3,0,0), mar=c(2,8,8,2)) # all plots on one page 
if(plot_ensemble){
   ...
   lines(c_7_mean+c_7_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
   lines(c_7_mean-c_7_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
}
# Move axis to top and left
axis(3,at=seq(0.0,200.0,by=20),cex.axis=3)
...
mtext("Soil Depth (cm)", side=2, outer=TRUE, line=-2, cex=3)
mtext("Organic Carbon Density (kgC/m3)", side=3, outer=TRUE,line=-3.7,cex=3)
text(110, 120, "Pacific Mountain Transition", cex = 3)
dev.off()
...
if(plot_ensemble){
   ...
   pdf(file="Intermontaneboreal_clean.pdf", width=17, height=10)
}
# Set margin
par(omi=c(0,0.3,0,0), mar=c(2,8,8,2)) # all plots on one page 
if(plot_ensemble){
   ...
   lines(c_8_mean+c_8_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
   lines(c_8_mean-c_8_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
}
# Move axis to top and left
...
mtext("Soil Depth (cm)", side=2, outer=TRUE, line=-2, cex=3)
mtext("Organic Carbon Density (kgC/m3)", side=3, outer=TRUE,line=-3.7,cex=3)
text(110, 120, "Intermontane Boreal", cex = 3)
dev.off()
...
#   lines(c_9_mean+c_9_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
#   lines(c_9_mean-c_9_sd, depth, lwd = 4, xaxt='n', yaxt='n', col="gray50")
#}
## Move axis to top and left
