...
fncscdnc <- 'ncscdv2_soilc_0.5x0.5.nc'   # Share the same header
fwetnc <- 'min_fw_frac.nc'   # Share the same header
...
# # Open and read in NCSCD NC file
# nc <- open.nc(fncscdnc, write=TRUE)
# # get the size of lat and lon
# londim <- dim.inq.nc(nc, "lon")
# latdim <- dim.inq.nc(nc, "lat")
# 
