...
############## Ecoregion ######################
# 9 different ecoregions are involved
# 1 = Bering Taiga
# 2 = Aleutian Meadows
...
title_ecoregion = c('Bering Taiga', 'Aleutian Meadows', 'Alaska Range Transition', 'Coastal Rainforest',
                'Arctic Tundra', 'Bering Tundra', 'Pacific Mountain Transition', 'Intermontane Boreal', 'Coast Mountain Transition')
############## Soil Orders ####################
...
c_andisol_ecoregion = info$Ecoregions[c_andisol_id]
...
c_entisol_ecoregion = info$Ecoregions[c_entisol_id]
...
c_inceptisol_ecoregion = info$Ecoregions[c_inceptisol_id]
...
c_spodosol_ecoregion = info$Ecoregions[c_spodosol_id]
...
c_gelisol_histel_ecoregion = info$Ecoregions[c_gelisol_histel_id]
...
c_gelisol_orthel_ecoregion = info$Ecoregions[c_gelisol_orthel_id]
...
c_gelisol_turbel_ecoregion = info$Ecoregions[c_gelisol_turbel_id]
...
if(plot_ensemble){
   ...
   pdf(file="Andisol_ecoregion.pdf", width=17, height=10)
}
# Set margin
par(omi=c(0,0.3,0,0), mar=c(2,8,8,2)) # all plots on one page 
if(plot_ensemble){
   ...
   lines(andisol_mean-andisol_se, depth_ens, type = 'l', lty = 3, lwd = 2, col = 1:length(s_andisol_ecoregion), ylim=rev(c(0,200)))
   lines(andisol_mean+andisol_se, depth_ens, type = 'l', lty = 3, lwd = 2, col = 1:length(s_andisol_ecoregion), ylim=rev(c(0,200)))
...
axis(2,at=seq(200,0,by=-20),labels=FALSE,tcl=-0.25)
grid(NULL, NULL, col = "lightgray", lty = "dotted", lwd = 3, equilogs = TRUE)
legend("bottomright", legend = title_ecoregion[as.numeric(names(s_andisol_ecoregion))], lty = 1, cex = 2.5, col = 1:length(s_andisol_ecoregion)) #cex=3, pch = 17, bty = "n")
     #  pch = "*", ncol = 4, cex = 0.8)
# Put Label for X and Y axis
mtext("Soil Depth (cm)", side=2, outer=TRUE, line=-2, cex=3)
mtext("Organic Carbon Density (kgC/m2)", side=3, outer=TRUE,line=-3.7,cex=3)
...
if(plot_ensemble){
   ...
   pdf(file="Entisol_ecoregion.pdf", width=17, height=10)
}
# Set margin
par(omi=c(0,0.3,0,0), mar=c(2,8,8,2)) # all plots on one page 
if(plot_ensemble){
   ...
   lines(entisol_mean-entisol_se, depth_ens, type = 'l', lty = 3, lwd = 2, col = 1:length(s_entisol_ecoregion), ylim=rev(c(0,200)))
   lines(entisol_mean+entisol_se, depth_ens, type = 'l', lty = 3, lwd = 2, col = 1:length(s_entisol_ecoregion), ylim=rev(c(0,200)))
...
axis(2,at=seq(200,0,by=-20),labels=FALSE,tcl=-0.25)
grid(NULL, NULL, col = "lightgray", lty = "dotted", lwd = 3, equilogs = TRUE)
legend("bottomright", legend = title_ecoregion[as.numeric(names(s_entisol_ecoregion))], lty = 1, cex = 2.5, col = 1:length(s_entisol_ecoregion)) #cex=3, pch = 17, bty = "n")
#legend(100, 150, legend = c("Fitted profile", "Fitted profile +- 1 STD"), cex=3, lty=1, col=c("black","gray50"), lwd=3, bty = "n")#, lty = 1:7,
     #  pch = "*", ncol = 4, cex = 0.8)
# Put Label for X and Y axis
mtext("Soil Depth (cm)", side=2, outer=TRUE, line=-2, cex=3)
...
#} else{
#   pdf(file="Histosol_ecoregion.pdf", width=17, height=10)
#}
## Set margin
#par(omi=c(0,0.3,0,0), mar=c(2,8,8,2)) # all plots on one page 
#if(plot_ensemble){
...
#   lines(histosol_mean-histosol_se, depth_ens, type = 'l', lty = 3, lwd = 2, col = 1:length(s_histosol_ecoregion), ylim=rev(c(0,200)))
#   lines(histosol_mean+histosol_se, depth_ens, type = 'l', lty = 3, lwd = 2, col = 1:length(s_histosol_ecoregion), ylim=rev(c(0,200)))
...
#axis(2,at=seq(200,0,by=-20),labels=FALSE,tcl=-0.25)
#grid(NULL, NULL, col = "lightgray", lty = "dotted", lwd = 3, equilogs = TRUE)
#legend("bottomright", legend = title_ecoregion[as.numeric(names(s_histosol_ecoregion))], lty = 1, cex = 2.5, col = 1:length(s_histosol_ecoregion)) #cex=3, pch = 17, bty = "n")
#     #  pch = "*", ncol = 4, cex = 0.8)
## Put Label for X and Y axis
#mtext("Soil Depth (cm)", side=2, outer=TRUE, line=-2, cex=3)
#mtext("Organic Carbon Density (kgC/m2)", side=3, outer=TRUE,line=-3.7,cex=3)
...
if(plot_ensemble){
   ...
   pdf(file="Inceptisol_ecoregion.pdf", width=17, height=10)
}
# Set margin
par(omi=c(0,0.3,0,0), mar=c(2,8,8,2)) # all plots on one page 
if(plot_ensemble){
   ...
   lines(inceptisol_mean-inceptisol_se, depth_ens, type = 'l', lty = 3, lwd = 2, col = 1:length(s_inceptisol_ecoregion), ylim=rev(c(0,200)))
   lines(inceptisol_mean+inceptisol_se, depth_ens, type = 'l', lty = 3, lwd = 2, col = 1:length(s_inceptisol_ecoregion), ylim=rev(c(0,200)))
...
axis(2,at=seq(200,0,by=-20),labels=FALSE,tcl=-0.25)
grid(NULL, NULL, col = "lightgray", lty = "dotted", lwd = 3, equilogs = TRUE)
legend("bottomright", legend = title_ecoregion[as.numeric(names(s_inceptisol_ecoregion))], lty = 1, cex = 2.5, col = 1:length(s_inceptisol_ecoregion)) #cex=3, pch = 17, bty = "n")
     #  pch = "*", ncol = 4, cex = 0.8)
# Put Label for X and Y axis
mtext("Soil Depth (cm)", side=2, outer=TRUE, line=-2, cex=3)
mtext("Organic Carbon Density (kgC/m2)", side=3, outer=TRUE,line=-3.7,cex=3)
...
if(plot_ensemble){
   ...
   pdf(file="Spodosol_ecoregion.pdf", width=17, height=10)
}
# Set margin
par(omi=c(0,0.3,0,0), mar=c(2,8,8,2)) # all plots on one page 
if(plot_ensemble){
   ...
   lines(spodosol_mean-spodosol_se, depth_ens, type = 'l', lty = 3, lwd = 2, col = 1:length(s_spodosol_ecoregion), ylim=rev(c(0,200)))
   lines(spodosol_mean+spodosol_se, depth_ens, type = 'l', lty = 3, lwd = 2, col = 1:length(s_spodosol_ecoregion), ylim=rev(c(0,200)))
...
axis(2,at=seq(200,0,by=-20),labels=FALSE,tcl=-0.25)
grid(NULL, NULL, col = "lightgray", lty = "dotted", lwd = 3, equilogs = TRUE)
legend("bottomright", legend = title_ecoregion[as.numeric(names(s_spodosol_ecoregion))], lty = 1, cex = 2.5, col = 1:length(s_spodosol_ecoregion)) #cex=3, pch = 17, bty = "n")
     #  pch = "*", ncol = 4, cex = 0.8)
# Put Label for X and Y axis
mtext("Soil Depth (cm)", side=2, outer=TRUE, line=-2, cex=3)
mtext("Organic Carbon Density (kgC/m2)", side=3, outer=TRUE,line=-3.7,cex=3)
...
if(plot_ensemble){
   ...
   pdf(file="Histel_ecoregion.pdf", width=17, height=10)
}
# Set margin
par(omi=c(0,0.3,0,0), mar=c(2,8,8,2)) # all plots on one page 
if(plot_ensemble){
   ...
   lines(gelisol_histel_mean-gelisol_histel_se, depth_ens, type = 'l', lty = 3, lwd = 2, col = 1:length(s_gelisol_histel_ecoregion), ylim=rev(c(0,200)))
   lines(gelisol_histel_mean+gelisol_histel_se, depth_ens, type = 'l', lty = 3, lwd = 2, col = 1:length(s_gelisol_histel_ecoregion), ylim=rev(c(0,200)))
...
axis(2,at=seq(200,0,by=-20),labels=FALSE,tcl=-0.25)
grid(NULL, NULL, col = "lightgray", lty = "dotted", lwd = 3, equilogs = TRUE)
legend("bottomright", legend = title_ecoregion[as.numeric(names(s_gelisol_histel_ecoregion))], lty = 1, cex = 2.5, col = 1:length(s_gelisol_histel_ecoregion)) #cex=3, pch = 17, bty = "n")
     #  pch = "*", ncol = 4, cex = 0.8)
# Put Label for X and Y axis
mtext("Soil Depth (cm)", side=2, outer=TRUE, line=-2, cex=3)
mtext("Organic Carbon Density (kgC/m2)", side=3, outer=TRUE,line=-3.7,cex=3)
...
if(plot_ensemble){
   ...
   pdf(file="Orthel_ecoregion.pdf", width=17, height=10)
}
# Set margin
par(omi=c(0,0.3,0,0), mar=c(2,8,8,2)) # all plots on one page 
if(plot_ensemble){
   ...
   lines(gelisol_orthel_mean-gelisol_orthel_se, depth_ens, type = 'l', lty = 3, lwd = 2, col = 1:length(s_gelisol_orthel_ecoregion), ylim=rev(c(0,200)))
   lines(gelisol_orthel_mean+gelisol_orthel_se, depth_ens, type = 'l', lty = 3, lwd = 2, col = 1:length(s_gelisol_orthel_ecoregion), ylim=rev(c(0,200)))
...
axis(2,at=seq(200,0,by=-20),labels=FALSE,tcl=-0.25)
grid(NULL, NULL, col = "lightgray", lty = "dotted", lwd = 3, equilogs = TRUE)
legend("bottomright", legend = title_ecoregion[as.numeric(names(s_gelisol_orthel_ecoregion))], lty = 1, cex = 2.5, col = 1:length(s_gelisol_orthel_ecoregion)) #cex=3, pch = 17, bty = "n")
     #  pch = "*", ncol = 4, cex = 0.8)
# Put Label for X and Y axis
mtext("Soil Depth (cm)", side=2, outer=TRUE, line=-2, cex=3)
mtext("Organic Carbon Density (kgC/m2)", side=3, outer=TRUE,line=-3.7,cex=3)
...
if(plot_ensemble){
   ...
   pdf(file="Turbel_ecoregion.pdf", width=17, height=10)
}
# Set margin
par(omi=c(0,0.3,0,0), mar=c(2,8,8,2)) # all plots on one page 
if(plot_ensemble){
   ...
   lines(gelisol_turbel_mean-gelisol_turbel_se, depth_ens, type = 'l', lty = 3, lwd = 2, col = 1:length(s_gelisol_turbel_ecoregion), ylim=rev(c(0,200)))
   lines(gelisol_turbel_mean+gelisol_turbel_se, depth_ens, type = 'l', lty = 3, lwd = 2, col = 1:length(s_gelisol_turbel_ecoregion), ylim=rev(c(0,200)))
...
axis(2,at=seq(200,0,by=-20),labels=FALSE,tcl=-0.25)
grid(NULL, NULL, col = "lightgray", lty = "dotted", lwd = 3, equilogs = TRUE)
legend("bottomright", legend = title_ecoregion[as.numeric(names(s_gelisol_turbel_ecoregion))], lty = 1, cex = 2.5, col = 1:length(s_gelisol_turbel_ecoregion)) #cex=3, pch = 17, bty = "n")
     #  pch = "*", ncol = 4, cex = 0.8)
# Put Label for X and Y axis
mtext("Soil Depth (cm)", side=2, outer=TRUE, line=-2, cex=3)
mtext("Organic Carbon Density (kgC/m2)", side=3, outer=TRUE,line=-3.7,cex=3)
